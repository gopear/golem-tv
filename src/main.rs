...
fn main() {
    ...
    let tvs = [
        [
            ...
            TV::new(1, 5.0, 5.0, 5.0, 110.0, String::from("192.168.0.57")),
        ],
        [
            TV::new(2, 5.0, 5.0, 5.0, 110.0, String::from("192.168.0.56")),
            TV::new(3, 5.0, 5.0, 5.0, 110.0, String::from("192.168.0.58")),
        ],
    ];
    ...
    let pool = ThreadPool::new((wall_height * wall_width) as usize);
    let barrier = Arc::new(Barrier::new((wall_height * wall_width) as usize + 1));
